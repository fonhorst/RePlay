...
SECOND_LEVELS_MODELS_PARAMS = {
    ...
    "lama_fast": {
        ...
        "second_model_params": {
            ...
            "tuning_params": {'fit_on_holdout': True, 'max_tuning_iter': 101, 'max_tuning_time': 100}
        }
    },
...
YARN_SUBMIT_CONF = {
    ...
    "spark.executor.extraClassPath": "/jars/spark_3.1.1_synapseml_0.9.5_jars/*",
    "spark.driver.extraClassPath": "/jars/spark_3.1.1_synapseml_0.9.5_jars/*",
...
def _get_models_params(*model_names: str, params_dict: dict) -> Dict[str, Any]:
    #
    # if kwargs["get_optimized_params"]:
    #     FIRST_LEVELS_MODELS_PARAMS_OPTIMIZED = _collect_best_params(kwargs["base_path"], *model_names)
    #
    #     return {
    #         MODELNAME2FULLNAME[model_name]: FIRST_LEVELS_MODELS_PARAMS_OPTIMIZED[MODELNAME2FULLNAME[model_name]]
    #         for model_name in model_names
    #     }
    # else:
    return {
        MODELNAME2FULLNAME[model_name]: params_dict[MODELNAME2FULLNAME[model_name]]
        for model_name in model_names
    }
...
class ArtifactPaths:
    ...
    def _fs_prefix(self, path: str) -> str:
        return "hdfs://node21.bdcl:9000" + path  # "file://"
    ...
    @property
    def first_level_train_opt_path(self) -> str:
        return os.path.join(self.base_path, "first_level_train_opt.parquet")

    @property
    def first_level_train_opt(self) -> DataFrame:
        return self._get_session().read.parquet(self.first_level_train_opt_path)

    @property
    def first_level_val_opt(self) -> DataFrame:
        return self._get_session().read.parquet(self.first_level_val_opt_path)
    ...
    @property
    def first_level_train(self) -> DataFrame:
        return self._get_session().read.parquet(self.first_level_train_path)

    @property
    def second_lvl_positives(self) -> DataFrame:
        return self._get_session().read.parquet(self.second_level_positives_path)
